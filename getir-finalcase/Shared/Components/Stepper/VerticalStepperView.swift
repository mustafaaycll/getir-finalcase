...
class VerticalStepperView: UIView {
    ...
    private func configureViewAndConstraints(of state: StepperStates) {
        ...
        case .expandedButReadyToBeCollapsedState:
            ...
            NSLayoutConstraint.activate([
                stepCountView.leadingAnchor.constraint(equalTo: self.leadingAnchor),
                stepCountView.topAnchor.constraint(equalTo: plusButton.bottomAnchor),
                stepCountView.trailingAnchor.constraint(equalTo: self.trailingAnchor),
                stepCountView.heightAnchor.constraint(
                    equalTo: self.heightAnchor,
                    multiplier: Config.Components.Stepper.Dimensions.buttonViewProportion
                )
            ])
            ...
            NSLayoutConstraint.activate([
                ...
                trashButton.topAnchor.constraint(equalTo: stepCountView.bottomAnchor),
                trashButton.trailingAnchor.constraint(equalTo: self.trailingAnchor),
                trashButton.heightAnchor.constraint(
                    equalTo: self.heightAnchor,
                    multiplier: Config.Components.Stepper.Dimensions.buttonViewProportion
                )
            ])
        case .expandedState:
            ...
            NSLayoutConstraint.activate([
                ...
                minusButton.topAnchor.constraint(equalTo: stepCountView.bottomAnchor),
